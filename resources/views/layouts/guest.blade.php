...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-pink-950 antialiased">
        <div class="flex flex-row">

        
            <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-rose-800 basis-1/2">
                <div>
                    {{-- <a href="/">
                ...
                <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-yellow-50 shadow-md overflow-hidden sm:rounded-lg">
                    {{ $slot }}
                </div>
            </div>
